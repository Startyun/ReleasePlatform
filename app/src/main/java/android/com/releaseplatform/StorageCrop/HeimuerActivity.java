...
public class HeimuerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tet_name.setText("农场品名： 黑木耳");
        tet_price.setText("价格:  8.9"+"元");
        tet_kucun.setText("库存:  56");
        tet_yunfei.setText("运费:  10"+"元");
        tet_fahuodi.setText("发货地:  南宁");
        tet_describe.setText("产品描述:  黑木耳，又名黑菜，桑耳、本菌、树鸡、木蛾、木茸，因形似耳，加之其颜色黑褐色而得名，黑木耳为木耳科植物，其性平味甘，人胃、大肠经。具有滋补、润燥、养血益胃、活血止血、润肺、润肠的作用。");
        tet_username.setText("黑木耳专卖");
        imageArray=new ArrayList<Integer>();
        imageArray.add(R.drawable.pic_search5);
        imageArray.add(R.drawable.pic_search55);
        imageArray.add(R.drawable.pic_search555);
        Glide.with(HeimuerActivity.this).load(R.drawable.pic_search5).into(ima);
        Glide.with(HeimuerActivity.this).load(R.drawable.pic_search55).into(ima1);
        Glide.with(HeimuerActivity.this).load(R.drawable.pic_search555).into(ima2);
        Glide.with(HeimuerActivity.this).load(R.drawable.pic_touxiang).into(circleImageView);
        InitBanner();
    }
    ...
    public void InitBanner(){
        ...
        banner.setOnBannerListener(new OnBannerListener() {
            ...
            public void OnBannerClick(int position) {
                Toast.makeText(HeimuerActivity.this,"你点啥点！！！",Toast.LENGTH_SHORT).show();
            }
        });
