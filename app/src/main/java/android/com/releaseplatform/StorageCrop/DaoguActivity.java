...
public class DaoguActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tet_name.setText("农场品名： 稻谷");
        tet_price.setText("价格:  5.9"+"元");
        tet_kucun.setText("库存:  56");
        tet_yunfei.setText("运费:  10"+"元");
        tet_fahuodi.setText("发货地:  南宁");
        tet_describe.setText("产品描述:  稻谷，是指没有去除稻壳的子实，在植物学上属禾本科稻属普通栽培稻亚属中的普通稻亚种。人类共确认出22类稻谷，但是唯一用于大宗贸易的是普通类稻谷。");
        tet_username.setText("稻谷专卖");
        imageArray=new ArrayList<Integer>();
        imageArray.add(R.drawable.pic_search4);
        imageArray.add(R.drawable.pic_search44);
        imageArray.add(R.drawable.pic_search444);
        Glide.with(DaoguActivity.this).load(R.drawable.pic_search4).into(ima);
        Glide.with(DaoguActivity.this).load(R.drawable.pic_search44).into(ima1);
        Glide.with(DaoguActivity.this).load(R.drawable.pic_search444).into(ima2);
        Glide.with(DaoguActivity.this).load(R.drawable.pic_touxiang).into(circleImageView);
        InitBanner();
    }
    ...
    public void InitBanner(){
        ...
        banner.setOnBannerListener(new OnBannerListener() {
            ...
            public void OnBannerClick(int position) {
                Toast.makeText(DaoguActivity.this,"你点啥点！！！",Toast.LENGTH_SHORT).show();
            }
        });
